...
const companyTests = [
  ...
  {
    id: "COM002", 
    name: "Infosys Technical Assessment",
    assignedDate: "2024-01-22",
    batch: "2026",
    assignedBranches: ["CSE-B", "EEE-A"],
    attempts: 25,
    totalStudents: 30,
    company: "Infosys"
  },
...
export default function CompanySpecific() {
  ...
  const handleViewReport = (testId: string) => {
    const test = companyTests.find(t => t.id === testId);
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-foreground">Company Specific Tests</h1>
          <p className="text-muted-foreground">Manage company-specific assessment reports</p>
        </div>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>Company Specific Tests</CardTitle>
        </CardHeader>
            ...
            <TableBody>
              {filteredTests.map((test) => (
                <TableRow key={test.id}>
                  ...
                  <TableCell>
                    <Badge variant="default">{test.company}</Badge>
                  </TableCell>
