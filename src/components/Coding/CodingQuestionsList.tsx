...
const CodingQuestionsList: React.FC = () => {
  ...
  const fetchQuestions = async () => {
    try {
      const response = await api.get('/api/coding/questions');
  ...
  const handleCreateQuestion = async (questionData: any) => {
    try {
      await api.post('/api/coding/questions', questionData);
      setShowForm(false);
      fetchQuestions();
    } catch (error) {
  ...
  const handleUpdateQuestion = async (questionData: any) => {
    try {
      await api.put(`/api/coding/questions/${editingQuestion.id}`, questionData);
      setShowForm(false);
  ...
  const handleDeleteQuestion = async (id: string) => {
    ...
    try {
      await api.delete(`/api/coding/questions/${id}`);
      fetchQuestions();
    } catch (error) {
  ...
  const handleEdit = async (question: CodingQuestion) => {
    try {
      const response = await api.get(`/api/coding/questions/${question.id}`);
